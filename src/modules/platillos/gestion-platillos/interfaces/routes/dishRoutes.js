...
// Platillos
router.post('/', handleUpload, authorize('dishes.create'), (req, res, next) => DishController.create(req, res, next));
...
router.post('/:id/image', handleUpload, authorize('dishes.edit'), (req, res, next) => DishController.uploadImage(req, res, next));
